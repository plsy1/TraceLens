...
#define TRACELENS_TLS_API_OPENSSL_CONNECT 1
#define TRACELENS_TLS_API_OPENSSL_GET_SERVERNAME 2
#define TRACELENS_TLS_API_OPENSSL_GET_VERSION 3
#define TRACELENS_TLS_API_OPENSSL_GET_FD 4
#define TRACELENS_TLS_API_OPENSSL_SET_FD 5
#define TRACELENS_TLS_API_OPENSSL_READ 6
#define TRACELENS_TLS_API_OPENSSL_WRITE 7
#define TRACELENS_TLS_API_OPENSSL_READ_EX 8
#define TRACELENS_TLS_API_OPENSSL_WRITE_EX 9
#define TRACELENS_TLS_API_GNUTLS_HANDSHAKE 20
#define TRACELENS_TLS_API_GNUTLS_SET_FD 21
#define TRACELENS_TLS_API_GNUTLS_RECV 22
#define TRACELENS_TLS_API_GNUTLS_SEND 23
#define TRACELENS_TLS_API_GNUTLS_SERVER_NAME 24
#define TRACELENS_TLS_API_GNUTLS_PROTOCOL 25
#define TRACELENS_TLS_API_NSS_IMPORT_FD 40
#define TRACELENS_TLS_API_NSPR_READ 41
#define TRACELENS_TLS_API_NSPR_WRITE 42
#define TRACELENS_TLS_API_NSS_SET_URL 43
#define TRACELENS_TLS_API_NSS_CHANNEL_INFO 44
#define TRACELENS_TLS_API_RUSTLS_READ 60
#define TRACELENS_TLS_API_RUSTLS_WRITE 61
#define TRACELENS_TLS_API_RUSTLS_PROCESS_PACKETS 62
