...
struct HealthResponse {
    ...
    userspace_raw_event_count: u64,
    userspace_decoded_event_count: u64,
    userspace_poll_error_count: u64,
    event_queue_capacity: Option<usize>,
    dropped_probe_events: u64,
    ...
    let body = match path {
        "/api/health" => response_json(|| {
            ...
            Ok(HealthResponse {
                ...
                userspace_raw_event_count: userspace.raw_events,
                userspace_decoded_event_count: userspace.decoded_events,
                userspace_poll_error_count: userspace.poll_errors,
                event_queue_capacity: core.event_queue_capacity(),
                dropped_probe_events: core.dropped_probe_events(),
